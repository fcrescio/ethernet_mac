...
#
# Generated by export_simulation on Thu Feb 16 17:05:30 CET 2017
#
################################################################################
...
./ethernet_mac_tx_fifo_xilinx.sh
...
switch to the './ethernet_mac_tx_fifo_xilinx.sh' script.

./ethernet_mac_tx_fifo_xilinx.sh -reset_run
...
./ethernet_mac_tx_fifo_xilinx.sh -noclean_files

For more information on the script, please type './ethernet_mac_tx_fifo_xilinx.sh -help'.
